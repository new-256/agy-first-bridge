 ...
 * @description 组合树里 name: agy-indicator 裸名行的宿主半边入口 —— 空操作占位。
 ...
 * index.mjs 里的 ctx.provide('agyCollector') 二次注册同名服务 → 后端启动崩溃
 * ("service ... has been registered at <agy-indicator>")。
 */
export const name = 'agy-indicator-client'
